...
window.ICONOS = {
  ...
  /* Espacios autogestivos: «storefront» bold, bajado el 13/9/2026 de
     github.com/phosphor-icons/core (assets/bold), no copiado de memoria. */
  espacios:
  ...
  /* Este NO es de Phosphor: está dibujado a mano acá, con rectas sobre
     la misma grilla de 256. Phosphor tiene su flecha de subir, pero
     copiarla de memoria es copiarla mal, y un ícono con un nodo torcido
     se nota. Son dos figuras: la flecha para arriba y la bandeja
     abierta abajo. */
  subir:
    '<path d="M112,96 L64,96 L128,32 L192,96 L144,96 L144,160 L112,160 Z'
    + 'M40,152 L64,152 L64,192 L192,192 L192,152 L216,152 L216,216 L40,216 Z"/>',
