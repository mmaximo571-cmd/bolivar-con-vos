...
### Community 4 - "app.js"
Cohesion: 0.11
Nodes (19): avisarMostrandoGuardado(), avisarNoSePudoActualizar(), cajaDelAviso(), CARRERAS_APP, desdeCuando(), errorEnCastellano(), explicarError(), __hitosDeEstaVisita (+11 more)
...
- **Why does `Pantalla Mi año (carrera)` connect `Pantalla Mi año (carrera)` to `persistir (guardado local de trayectoria)`, `Pantalla Cátedras`, `Pantalla Info útil (trámites y FAQ)`, `app.js`, `elegirCarrera`, `Detalle de publicación (?id=)`, `localStorage bolivar-carrera-resumen`, `Mi perfil (mi/index.html)`?**
